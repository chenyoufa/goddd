...
func NewStackContext(ctx context.Context, tag string) context.Context {
	return context.WithValue(ctx, stackKey{}, tag)
}

func FromStackContext(ctx context.Context) string {
